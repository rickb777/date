...
var (
	d0320 = New(2015, time.March, 20)
	d0321 = New(2015, time.March, 21)
	d0325 = New(2015, time.March, 25)
	d0326 = New(2015, time.March, 26)
	d0327 = New(2015, time.March, 27)
	d0328 = New(2015, time.March, 28)
	d0329 = New(2015, time.March, 29) // n.b. clocks go forward (UK)
	d0330 = New(2015, time.March, 30)
	d0331 = New(2015, time.March, 31)
	d0401 = New(2015, time.April, 1)
	d0402 = New(2015, time.April, 2)
	d0403 = New(2015, time.April, 3)
	d0404 = New(2015, time.April, 4)
	d0407 = New(2015, time.April, 7)
	d0408 = New(2015, time.April, 8)
	d0409 = New(2015, time.April, 9)
...
func TestEmptyRange(t *testing.T) {
	...
	isEq(t, 0, dr0.IsEmpty(), true)
	isEq(t, 0, dr0.String(), "0 days at 0001-01-01")
